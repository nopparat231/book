  ...
  <div class="row" style="padding-top:50px">
    ...
    <div class="col-md-10" style="background-color:#f4f4f4">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_password" type="password" required class="form-control" id="txtNewPassword" placeholder="password" pattern="^[a-zA-Z0-9]+$" minlength="2" />
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_password" type="password" id="txtConfirmPassword" onkeyup="checkPasswordMatch();" required class="form-control" id="mem_password" placeholder="password" pattern="^[a-zA-Z0-9]+$" minlength="2" />
