  ...
  <div class="row" style="padding-top:50px">
    ...
    <div class="col-md-10" style="background-color:#f4f4f4">
      ...
      <form  name="register" action="register_db.php" method="POST" id="register" class="form-horizontal">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_username" type="text" required class="form-control" id="mem_username" placeholder="ยูสเซอร์เนม" pattern="^[a-zA-Z0-9]+$" title="ภาษาอังกฤษหรือตัวเลขเท่านั้น" minlength="2"  />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_password" type="password" required class="form-control" id="txtNewPassword" placeholder="พาสเวิร์ด" pattern="^[a-zA-Z0-9]+$" minlength="2" />
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_password" type="password" id="txtConfirmPassword" onkeyup="checkPasswordMatch();" required class="form-control" id="mem_password" placeholder="ยืนยันพาสเวิร์ด" pattern="^[a-zA-Z0-9]+$" minlength="2" />
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" align="left">
          <input  name="mem_email" type="E-mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required class="form-control" id="mem_email" placeholder="อีเมลล์" title="กรุณากรอก Email ให้ถูกต้อง" minlength="2"/>
        </div>
      </div>
